...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .sidebar-topbar img { width: 34px; height: 34px; border-radius: 50%; object-fit: cover; }
  ...
  .sidebar-close-btn {
    width: 32px; height: 32px; background: #ecedf3; border: none;
  ...
  .admin-sidebar .nav-link {
    ...
    color: #333; text-decoration: none; font-size: 14.5px;
    transition: background 0.18s, color 0.18s;
  }
  .admin-sidebar .nav-link i { font-size: 17px; min-width: 20px; }
  .admin-sidebar .nav-link:hover,
  .admin-sidebar .nav-link.active { background: var(--sidebar-hover); color: #fff; }
  ...
  .sidebar-footer { padding: 10px; border-top: 1px solid #ebebeb; flex-shrink: 0; }
